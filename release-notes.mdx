---
title: "Release Notes"
description: "Public API (v2) release notes, generated from the openapi.json diff between releases."
---

<Info>
**Source**

Copied directly from [CHANGELOG.md](https://gitlab.logicgate.dev/eric.belisle/openapi/-/blob/main/CHANGELOG.md)
in the `openapi` repo, which is auto-generated from the diff between each release's `openapi.json`.
This is the authoritative version — more complete than the portal's per-version pages, which only
go back to v2021.1.0.
</Info>
